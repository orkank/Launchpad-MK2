...
def synthwave_animation(midi_out):
...
def meditation_animation(midi_out):
...
if __name__ == '__main__':
    try:
        ...
        print("'r' - Randomize animations for all playlists")
        print("'q' - Quit")
